    ...
    _injectTimePicker: function() {
      ...
      if ($dp.find("div.ui-timepicker-div").length === 0 && o.showTimepicker) {
        ...
        for (i = 0, l = this.units.length; i < l; i++) {
          ...
          max[litem] = parseInt(
            o[litem + "Max"] -
              ((o[litem + "Max"] - o[litem + "Min"]) % o["step" + uitem]),
            10
          );
          gridSize[litem] = 0;
        ...
        // Timezone
        var showTz =
          o.showTimezone !== null ? o.showTimezone : this.support.timezone;
        html +=
      ...
      if (dp_inst.settings.minTime !== null) {
        ...
        if (this.hour < tempMinTime.getHours()) {
          ...
          if (this._defaults.hourMin < tempMinTime.getHours()) {
            ...
            (this._defaults.hourMin === tempMinTime.getHours()) === this.hour &&
            this._defaults.minuteMin < tempMinTime.getMinutes()
          ) {
            this._defaults.minuteMin = tempMinTime.getMinutes();
          } else {
      ...
      if (dp_inst.settings.maxTime !== null) {
        ...
        if (this.hour > tempMaxTime.getHours()) {
          ...
          if (this._defaults.hourMax > tempMaxTime.getHours()) {
            ...
            (this._defaults.hourMax === tempMaxTime.getHours()) === this.hour &&
            this._defaults.minuteMax > tempMaxTime.getMinutes()
          ) {
            this._defaults.minuteMax = tempMaxTime.getMinutes();
          } else {
  ...
  $.datepicker.parseTime = function(timeFormat, timeString, options) {
    ...
    var strictParse = function(f, s, o) {
      ...
      var regstr =
          ...
          f
            .toString()
            .replace(/([hH]{1,2}|mm?|ss?|[tT]{1,2}|[zZ]|[lc]|'.*?')/g, function(
              match
            ) {
              var ml = match.length;
        ...
        switch (match) {
          ...
          case "z":
            return $.timepicker.timezoneOffsetString(
              time.timezone === null ? options.timezone : time.timezone,
              false
            );
          case "Z":
            return $.timepicker.timezoneOffsetString(
  ...
  $.datepicker._doKeyPress = function(event) {
    ...
    if (tp_inst) {
      if ($.datepicker._get(inst, "constrainInput")) {
        ...
        return (
          event.ctrlKey ||
          (chr < " " || !dateChars || datetimeChars.indexOf(chr) > -1)
        );
      }
    }
  ...
  $.datepicker._updateAlternate = function(inst) {
    ...
    if (tp_inst) {
      ...
      if (altField) {
        ...
        altFormattedDateTime +=
          $.datepicker.formatTime(altTimeFormat, tp_inst, tp_inst._defaults) +
          altTimeSuffix;
        if (
          ...
          if (tp_inst._defaults.altFormat) {
            ...
            altFormattedDateTime =
              tp_inst.formattedDate + altSeparator + altFormattedDateTime;
          }
        }
